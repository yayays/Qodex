...
async function main(): Promise<void> {
  ...
  output.write(
    'Commands: /help, /bind /path, /new, /status, /status+, /running, /memory, /remember <scope> <category> <content>, /forget <id>, /profile [scope] [path=value|path+=value|path-=value|!path], /summary [text|clear], /hint <scope> <text>, /unhint <id>, /approve <id>, /approveall [on|off], /reject <id>\n',
  );
